...
cp /root/.acme.sh/"${OMADA_HOSTNAME}"/"${OMADA_HOSTNAME}".cer /opt/tplink/EAPController/data/keystore/eap.cer
...
keytool -importkeystore -deststorepass tplink -destkeystore /opt/tplink/EAPController/data/keystore/eap.keystore -srckeystore /root/.acme.sh/"${OMADA_HOSTNAME}"/"${OMADA_HOSTNAME}".p12 -srcstoretype PKCS12 -srcstorepass tplink
